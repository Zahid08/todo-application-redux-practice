import canelImage from "../assets/images/cancel.png";
import {useDispatch} from "react-redux";
import {colorSelected, deleteToDo, markDown} from "../redux/todos/action";

export default function TodoItem({singleToDo}){

    const dispatch=useDispatch();

    const {id,text,completed,color}=singleToDo;

    const handleStatusChange = (todoId) => {
        dispatch(markDown(todoId));
    };

    const removeTodList=(id)=>{
